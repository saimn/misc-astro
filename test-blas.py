...
# Test to start. The dict is the value I had with the MKL using EPD 6.0 and
# without MKL using EPD 5.1
...
# Setting the following environment variable in the shell executing the script
# allows you limit the maximal number threads used for computation
...
def start_benchmark():
    ...
    for fun, bench in sorted(tests.items()):
